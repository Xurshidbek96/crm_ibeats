...
class StoreClientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'passport_serial' => 'required|string|max:20|unique:clients,passport_serial',
            'passport_number' => 'required|string|max:20|unique:clients,passport_number',
            'passport_given_date' => 'required|date|before_or_equal:today',
